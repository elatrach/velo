...
<table id="recap">
	<tr>
		<td style="background:#808080;width:15px;height:15px;"></td><td>Indisponible</td>
	</tr>
	<tr>
...
<table style="border:1px solid black;border-collapse:collapse;box-shadow: 10px 10px 5px #888888;">
	...
	<tr>
		...
		for($mois=1;$mois<=12;$mois++) {
			...
			$date_affiche = date('Y-m-d',strtotime($annee."-".$mois."-".$jour));
			?>
			<tr>
				<?php if ($date_affiche < $date_du_jour){ ?>
					<td style="background:#FFFFF;" border-bottom:1px solid #eee;><?php echo $jours[$Jr]; ?></td>			
					<td style="background:#FFFFFF;" border-bottom:1px solid #eee;width:20%;><?php echo $jour; ?></td>
				<?php } else { ?>
					<td style="<?php echo $JourReserve==1?"background:#808080;":"background:#88FF88;"; ?>border-bottom:1px solid #eee;"><?php echo $jours[$Jr]; ?></td>			
					<td style="<?php echo $JourReserve==1?"background:#808080;":"background:#88FF88;"; ?>border-bottom:1px solid #eee;width:20%;"><?php echo $jour; ?></td>
				<?php } ?>
				<?php 
				if($Jr>5){
					$Jr=0;
